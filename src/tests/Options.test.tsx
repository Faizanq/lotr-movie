...
describe("Options", () => {
  it("renders all questions", () => {
    const { getByText } = render(
      <Options selection={null} setSelection={() => {}} />
    );
  ...
  it("renders selected question with selected style", () => {
    const { getByText } = render(
      <Options selection="movie" setSelection={() => {}} />
    );
  ...
  it("renders non-selected question with non-selected style", () => {
    const { getByText } = render(
      <Options selection="character" setSelection={() => {}} />
    );
  ...
  it("calls setSelection with correct question on button click", () => {
    ...
    const { getByText } = render(
      <Options selection={null} setSelection={setSelectionMock} />
    );
